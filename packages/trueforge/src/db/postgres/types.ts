...
export interface EventSourceTable {
  ...
  manifest: JSONColumnType<EventSourceManifest, EventSourceManifest, EventSourceManifest>;
  /** Connector credentials; SQL NULL while pending. Never selected by listings. */
  secrets: JSONColumnType<EventSourceSecrets, EventSourceSecrets, EventSourceSecrets> | null;
...
export interface EventTable {
  ...
  subject_key: string;
  delivery_id: string;
  summary: JSONColumnType<EventSummary, EventSummary, EventSummary>;
  payload: JSONColumnType<JsonObject, JsonObject, JsonObject>;
  received_at: Date;
